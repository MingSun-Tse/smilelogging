...
setup(
  ...
  author_email = 'wang.huan@northeastern.edu',      # Type in your E-Mail
  url = 'https://github.com/MingSun-Tse/smilelogging',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/MingSun-Tse/smilelogging/archive/refs/tags/v0.2.11.tar.gz',    # I explain this later on
